...
import { ArrowLeft, Save, MapPin, Plus, X, Search, ImageIcon, Trash2, Link, FileText } from "lucide-react";
...
export function EditPage({recordId, source, onBack, onSessionExpired }: EditPageProps) {
    ...
    const handleSubmit = async (e: React.FormEvent, isDraft: boolean = false) => {
        ...
        try {
            ...
            toast.success('La fiche sera relue par un administrateur pour validation.');
        } catch (error) {
