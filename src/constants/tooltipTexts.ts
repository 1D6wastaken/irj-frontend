...
export const tooltipTexts = {
    ...
    monumentsLieux: {
        ...
        dimensions: "Dimensions du monument ou du lieu (longueur, largeur, hauteur, etc.).",
        altitude: "Altitude du lieu en mètres.",
        emplacement: "Emplacement précis du monument ou du lieu.",
        dateConstruction: "Date ou période de construction du monument.",
        premiereMention: "Date de la première mention connue dans les sources historiques.",
        proprietaireActuel: "Nom du propriétaire actuel du monument ou du lieu.",
        architecte: "Nom de l'architecte ou du maître d'œuvre.",
        commanditaire: "Personne ou institution ayant commandé la construction.",
    },
    ...
    mobiliersImages: {
        ...
        coteReference: "Cote ou référence de l'objet dans un inventaire ou un catalogue.",
        dateFabrication: "Date ou période de fabrication de l'objet.",
        auteurOeuvre: "Nom de l'auteur ou du créateur de l'œuvre.",
        commanditaire: "Personne ou institution ayant commandé la réalisation de l'œuvre.",
        emplacement: "Emplacement précis de l'objet dans l'édifice ou le lieu.",
        support: "Support de l'œuvre (ex: bois, toile, parchemin, pierre, etc.).",
        proprietaireActuel: "Nom du propriétaire actuel de l'objet.",
        dimensionsSupport: "Dimensions du support (hauteur x largeur x profondeur).",
        dimensionsImage: "Dimensions de l'image ou de la partie figurée.",
    },
    ...
    personnesMorales: {
        ...
        biens: "Biens matériels ou immobiliers possédés par l'organisation.",
        datePremiereMention: "Date de la première mention connue de l'organisation dans les sources.",
        dateDerniereMention: "Date de la dernière mention connue de l'organisation dans les sources.",
        refondationDate: "Date de refondation de l'organisation, si applicable.",
        dateFin: "Date de dissolution ou de fin d'activité de l'organisation.",
        origineSocialeProf: "Origine sociale et professionnelle des membres de l'organisation.",
        membresConnus: "Liste des membres connus de l'organisation.",
        frequenceReunions: "Fréquence et modalités des réunions de l'organisation.",
        participationViePol: "Participation de l'organisation à la vie politique locale ou nationale.",
        funerailles: "Pratiques funéraires de l'organisation.",
        autresFetes: "Autres fêtes et célébrations organisées.",
        inhumationCostume: "Pratiques d'inhumation et costume des membres.",
        fondateurs: "Noms et informations sur les fondateurs de l'organisation.",
        statuts: "Contenu ou résumé des statuts de l'organisation.",
        autorisations: "Autorisations obtenues par l'organisation (ecclésiastiques, civiles, etc.).",
    },
    ...
    personnesPhysiques: {
        ...
        historiography: "État de la recherche historiographique sur cette personne : études, débats, interprétations successives, etc.",
        ...
        evenements: "Événements marquants liés à la personne.",
        preparatifs: "Préparatifs du pèlerinage ou du voyage.",
        cheminSuivi: "Itinéraire ou chemin suivi lors du pèlerinage.",
        arrivee: "Informations sur l'arrivée au lieu de pèlerinage.",
        retour: "Informations sur le retour du pèlerinage.",
        nonExecution: "Raisons ou circonstances de la non-exécution du pèlerinage.",
        age: "Âge de la personne (au moment du pèlerinage ou à une date significative).",
        compositionGroupe: "Composition du groupe de pèlerins ou de voyage.",
    },
};
